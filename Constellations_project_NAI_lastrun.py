...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\helenaso\\Documents\\GitHub\\ANI_PROJECT\\Constellations_project_NAI_lastrun.py',
...
instruction1_2 = visual.ImageStim(
    win=win,
    name='instruction1_2', 
    image='introimg/intro0.png', mask=None, anchor='center',
...
instruction1 = visual.ImageStim(
    win=win,
    name='instruction1', 
    image='introimg/intro1.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 1.6),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
instruction2 = visual.ImageStim(
    win=win,
    name='instruction2', 
    image='introimg/intro2.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 1.6),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
instruction3 = visual.ImageStim(
    win=win,
    name='instruction3', 
    image='introimg/intro3.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 1.6),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
instruction4 = visual.ImageStim(
    win=win,
    name='instruction4', 
    image='introimg/intro4.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 1.6),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
practice_object = visual.ImageStim(
    ...
    image='introimg/practice.png', mask=None, anchor='center',
...
practice_outline = visual.ImageStim(
    ...
    image='introimg/practice_solution.png', mask=None, anchor='center',
    ori=0.0, pos=(0.0, 0.0), size=(0.65,0.65),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
instruction4_2 = visual.ImageStim(
    win=win,
    name='instruction4_2', 
    image='introimg/intro5.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 1.6),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
continueRoutine = True
# update component parameters for each repeat
practice_image.setImage('introimg/practice.jpg')
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('trial_final.csv'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        # Save answers
        if show_next_btn and button_next.contains(mouse) and mouse.getPressed()[0]:
    ...
    # save screenshot
    screenshot_filename = f"screenshots/{pseudonym}_trial{trial_counter}_screenshot{trial_counter}.png"
    win.getMovieFrame()
